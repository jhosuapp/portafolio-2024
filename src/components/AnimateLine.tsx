...
const AnimateLine = ({ top }:ICustomPropsAnimateLine ):JSX.Element => {
    ...
    return (
        <>
            {isDesk && 
                <svg className='animate-line' style={{ top: top ? top: '0' }} width="107%" height="1086" viewBox="0 0 1914 1086" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path 
                        style={{ pathLength }}
