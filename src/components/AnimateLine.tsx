...
import { ICustomPropsAnimateLine } from '@/models/components/animateLine.model';
//Hooks
import { useMediaQuery } from '@/hooks';


const AnimateLine = ({ top, className }:ICustomPropsAnimateLine ):JSX.Element => {
    ...
    return (
        <>
            {isDesk && 
                <svg className={`${className} animate-line`} style={{ top: top ? top: '0' }} width="107%" height="1086" viewBox="0 0 1914 1086" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path 
                        style={{ pathLength }}
